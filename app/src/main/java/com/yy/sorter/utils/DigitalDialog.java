...
public class DigitalDialog extends Dialog {
    ...
    public static class Builder implements AlwaysClickButton.LVMuiltClickCallBack{
        ...
        private LVCallback2 mCallback2=null;
        ...
        public Builder(Context context,LVCallback2 callback2,int max, int min, int value ,int par,Object tag) {
            this.context = context;
        ...
        public interface LVCallback2{
            public void onConfirmClick(int value, int par ,Object tag);
        }
            ...
            btnConfig.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (m_value<=Max && m_value>=Min)
                    {
                        ...
                        if(mCallback2 != null){
                            mCallback2.onConfirmClick(m_value,ParMsg,tag);
                        }
