package com.yy.sorter.permission;
...
public class PermissionUtils {
    ...
    private static final String[] requestPermissionsTips = {
            PERMISSION_RECORD_AUDIO,
            PERMISSION_GET_ACCOUNTS,
            PERMISSION_READ_PHONE_STATE,
            PERMISSION_CALL_PHONE,
...
//        }
        ...
        try {
            ...
            Toast.makeText(activity, "请开启"+requestPermissionsTips[requestCode], Toast.LENGTH_SHORT)
                    .show();
    ...
    private static void shouldShowRationale(final Activity activity, final int requestCode, final String requestPermission) {
        ...
        showMessageOKCancel(activity, "请开启权限 "+requestPermissionsTips[requestCode], new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
